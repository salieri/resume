  ...
  },
  {
    rules: {
      ...
      '@stylistic/padding-line-between-statements': ['error',
          ...
          { blankLine: "always", prev: "let", next: "multiline-const" },
          { blankLine: "always", prev: "multiline-const", next: "let" },
          { blankLine: "always", prev: "let", next: "multiline-let" },
          { blankLine: "always", prev: "multiline-let", next: "let" },
          { blankLine: "always", prev: "const", next: "multiline-let" },
          { blankLine: "always", prev: "multiline-let", next: "const" },
      ],
